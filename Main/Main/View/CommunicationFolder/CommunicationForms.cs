...
namespace Main.View.CommunicationFolder
{
    public partial class CommunicationForms : Form
    {
        ...
        ////Comunicação
        //Dictionary<SerialPort, IndicadorClass> indicadores_port = new Dictionary<SerialPort, IndicadorClass>();
        //public bool loop_condition = true;
        ...
        public CommunicationForms()
        {
            ...
            //if (indicadores_port.Count > 0) 
            //{
            //    tmRead.Interval = 60;
            //    tmRead.Elapsed += TmRead_Elapsed;
            //    foreach (var item in indicadores_port)
            //    {
            //        item.Key.DataReceived += Value_DataReceived;
            //    }
        ...
        //        foreach (var item in indicadores_port)
        //        {
        //            //Console.WriteLine($"Indicador ADDR: {item.Value.indicador.addr}\nSerialPort: {item.Key.PortName}\nItem AvailableStatus: {item.Value.availableStatus}");

        //            if (item.Value.availableStatus)
        //            {
        //                byte[] command = new byte[]
        //                {
        //                    Convert.ToByte(item.Value.indicador.addr),
        //                    0x03,
        //                    0x00,
        //                    0x0A,
        //                    0x00,
        ...
        //                item.Key.Write(command, 0, command.Length);
        //                item.Value.availableStatus = false;
        //            }
        //            else 
        //            {
        //                item.Value.availableStatus = true;
        //            }
        //        }
        ...
        //            {
        //                if (bruto[0] == Convert.ToByte(indicadores_port[received].indicador.addr) && bruto[1] == 0x03)
        //                {
        //                    indicadores_port[received].PS = CommunicationFormsHelper.PesoConverted(bruto[3], bruto[4], bruto[5], bruto[6]);
        //                    indicadores_port[received].PB = Convert.ToDouble(indicadores_port[received].PS);
        ...
        //        indicadores_port[received].availableStatus = true;
        //    }
        //    catch (Exception ex)
        //    {
        //    }
        ...
        //            {
        //                if (!Program.SERIALPORT1.IsOpen) { Program.SERIALPORT1.Open(); }
        //                IndicadorClass indicador01 = new IndicadorClass(Program.SERIALPORT1, indicador);
        //                indicador01.nome = Program.CFG.balanca_1;
        //                indicadores_port.Add(Program.SERIALPORT1, indicador01);

        //            }
        //            else if (indicador.nome == Program.CFG.balanca_2 && Program._autoconnect_3) 
        //            {
        //                if (!Program.SERIALPORT2.IsOpen) { Program.SERIALPORT2.Open(); } 
        //                IndicadorClass indicador02 = new IndicadorClass(Program.SERIALPORT2, indicador);
        //                indicador02.nome = Program.CFG.balanca_2;
        //                indicadores_port.Add(Program.SERIALPORT2, indicador02);
        //            }
        ...
        //    foreach (RedeClass indicador in _indicadores)
        //    {
        //        IndicadorClass indClass = new IndicadorClass(new SerialPort(), indicador);
        ...
        //private void CommunicationForms_FormClosed(object sender, FormClosedEventArgs e)
        //{
        //    try
        //    {
        //        tmRead.Stop();
        ...
        //public void TryAgainCommunication() 
        //{
        //    try
        //    {
        //        //LoadAll();
